...
export var SecurityService = (function () {
    function SecurityService(_http, _configuration, _router) {
        ...
        this.getUserData = function () {
            _this.setHeaders();
            return _this._http.get(_this.authorizationUrl + 'connect/userinfo', {
                headers: _this.headers,
                body: ''
            }).map(function (res) { return res.json(); });
        };
        this.actionUrl = _configuration.Server + '/api/DataEventRecords/';
        this.authorizationUrl = _configuration.Auth;
    ...
    SecurityService.prototype.Authorize = function () {
        ...
        var authorizationUrl = this.authorizationUrl + 'connect/authorize';
        var client_id = 'angular2client';
        var redirect_uri = this.serverUrl;
    ...
    SecurityService.prototype.Logoff = function () {
        console.log("BEGIN Authorize, no auth data");
        var authorizationUrl = this.authorizationUrl + 'connect/endsession';
        var id_token_hint = this.retrieve("authorizationDataIdToken");
        var post_logout_redirect_uri = this.authorizationUrl + 'Unauthorized';
        var url = authorizationUrl + "?" +
